defmodule PotionUiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PotionUiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PotionUiWeb.Gettext, "errors", msg, opts)
    end
  end
