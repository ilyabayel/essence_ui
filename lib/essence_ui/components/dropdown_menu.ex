defmodule EssenceUI.Components.DropdownMenu do
  ...
  def dropdown_menu_trigger(assigns) do
    ...
    <DropdownMenuPrimitive.trigger
      ...
      disabled={@disabled}
      as="div"
      class={["rt-DropdownMenuTrigger", @class, @rest[:class]] |> Enum.filter(& &1) |> Enum.join(" ")}
  ...
  def dropdown_menu_item(assigns) do
    ...
    <DropdownMenuPrimitive.item
      ...
      class={
        ["rt-reset", "rt-BaseMenuItem", "rt-DropdownMenuItem", @class, @rest[:class]]
        |> Enum.filter(& &1)
        |> Enum.join(" ")
      }
      data-accent-color={assigns[:color]}
  ...
  def dropdown_menu_separator(assigns) do
    ...
    <DropdownMenuPrimitive.separator
      class={
        ["rt-BaseMenuSeparator", "rt-DropdownMenuSeparator", @class, @rest[:class]]
        |> Enum.filter(& &1)
        |> Enum.join(" ")
      }
      {Map.delete(@rest, :class)}
  ...
  def dropdown_menu_label(assigns) do
    ...
    <DropdownMenuPrimitive.label
      class={
        ["rt-BaseMenuLabel", "rt-DropdownMenuLabel", @class, @rest[:class]]
        |> Enum.filter(& &1)
        |> Enum.join(" ")
      }
      {Map.delete(@rest, :class)}
  ...
  def dropdown_menu_checkbox_item(assigns) do
    ...
    >
      ...
      <DropdownMenuPrimitive.item_indicator
        force_mount={@checked}
        class="rt-BaseMenuItemIndicator rt-DropdownMenuItemIndicator"
      >
        <svg
          width="15"
          height="15"
  ...
  def dropdown_menu_sub(assigns) do
    ...
    <DropdownMenuPrimitive.sub
      open={@open}
      class={["rt-DropdownMenuSub", @class, @rest[:class]] |> Enum.filter(& &1) |> Enum.join(" ")}
      {Map.delete(@rest, :class)}
    >
      {render_slot(@inner_block)}
    </DropdownMenuPrimitive.sub>
