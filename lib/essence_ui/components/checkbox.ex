defmodule EssenceUI.Components.Checkbox do
  ...
  attr :required, :boolean, default: false, doc: "Whether the checkbox is required."
  attr :form, :string, default: nil, doc: "The form ID this checkbox belongs to."
  ...
  def checkbox(assigns) do
    ...
    checked_state = get_checked_state(assigns.checked, assigns.default_checked)
    ...
    <.root
      ...
      {@rest}
    >
      <.indicator class="rt-BaseCheckboxIndicator rt-CheckboxIndicator" state={@checked_state}>
        <%= if @checked_state == "indeterminate" do %>
          <svg
            width="9"
            height="9"
            viewBox="0 0 9 9"
  ...
  defp get_checked_state(checked, default_checked) do
    case checked || default_checked do
