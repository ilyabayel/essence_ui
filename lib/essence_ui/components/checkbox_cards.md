...
<div role="group" dir="ltr" class="est-Grid est-CheckboxCardsRoot est-r-size-2 est-variant-surface est-r-gtc-3" tabindex="0" id="checkbox-cards-123" phx-hook="CheckboxCards">
  <label class="est-BaseCard est-CheckboxCardsItem">
    <div class="est-Flex est-r-fd-column est-r-w" style="--width:100%">
      <span class="est-Text est-r-weight-bold">A1 Keyboard</span>
      <span class="est-Text">US Layout</span>
    </div>
    <button type="button" role="checkbox" aria-checked="true" data-state="checked" value="1" class="est-reset est-BaseCheckboxRoot est-CheckboxCardCheckbox est-r-size-2 est-variant-surface" tabindex="-1">
      <svg width="9" height="9" viewBox="0 0 9 9" fill="currentcolor" xmlns="http://www.w3.org/2000/svg" data-state="checked" class="est-BaseCheckboxIndicator" style="pointer-events: none;">
