defmodule Storybook.Primitives.PasswordToggleFieldStory do
  ...
  def container, do: {:div, class: "essence-demo", "data-component": "password-toggle-field"}
  ...
  def variations do
    [
      %Variation{
        id: :primitive,
        description: "Essence UI password toggle field demo",
        template: """
        <PasswordToggleField.root id="password-toggle-primitive">
          <div class="DemoRoot">
            <PasswordToggleField.input
              ...
              aria-label="Password"
            />
            <PasswordToggleField.toggle class="DemoToggle">
