defmodule Storybook.Themes.Components.DropdownMenu do
  ...
  def variations do
    [
      ...
      %Variation{
        id: :nested_subs,
        description: "Nested submenus (legacy touch/click)",
        template: """
        <.dropdown_menu_root id="dropdown-nested-subs">
          <.dropdown_menu_trigger>
            <.button variant="soft">
              Options
              <.dropdown_menu_trigger_icon />
          ...
          <.dropdown_menu_content>
            <.dropdown_menu_sub>
              ...
              <.dropdown_menu_sub_content>
                <.dropdown_menu_item>Move to project…</.dropdown_menu_item>
                <.dropdown_menu_sub>
                  <.dropdown_menu_sub_trigger>Advanced</.dropdown_menu_sub_trigger>
                  <.dropdown_menu_sub_content>
                    <.dropdown_menu_item>Deep option</.dropdown_menu_item>
                  </.dropdown_menu_sub_content>
                </.dropdown_menu_sub>
              </.dropdown_menu_sub_content>
            </.dropdown_menu_sub>
