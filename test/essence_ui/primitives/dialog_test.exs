defmodule EssenceUI.Primitives.DialogTest do
  ...
  test "renders dialog parts" do
    ...
    assert html =~ ~s[data-radix-dialog-trigger]
    assert html =~ ~s[data-phx-portal="body"]
    assert html =~ ~s[id="dlg-portal"]
    assert html =~ ~s[data-radix-dialog-overlay]
    assert html =~ ~s[role="dialog"]
    assert html =~ ~s[aria-modal="true"]
    assert html =~ ~s[data-radix-dialog-content]
    assert html =~ ~s[data-radix-dialog-title]
    assert html =~ ~s[data-radix-dialog-description]
    assert html =~ ~s[data-radix-dialog-close]
