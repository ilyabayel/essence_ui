...
3. Primitives: `variant="primitive" component="…" css={primitive_css("…")}` — CSS is an argument (not a slot); component CSS only in the CSS tab; preview isolates via Shadow DOM (`DocsDemoFrame`)
