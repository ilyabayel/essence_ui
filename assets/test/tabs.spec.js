...
test.describe('Tabs Primitive', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/primitives/tabs?variation_id=primitive');
    await page.waitForTimeout(500);
  });

  test('should activate tab on click and show matching content', async ({ page }) => {
    const root = page.locator('#tabs-primitive');
    const account = root.locator('[data-essence-tabs-trigger][data-value="account"]');
    const documents = root.locator('[data-essence-tabs-trigger][data-value="documents"]');
    const accountContent = root.locator('[data-essence-tabs-content][data-value="account"]');
    const documentsContent = root.locator('[data-essence-tabs-content][data-value="documents"]');
  ...
  test('should navigate with arrow keys', async ({ page }) => {
    ...
    const account = root.locator('[data-essence-tabs-trigger][data-value="account"]');
    const documents = root.locator('[data-essence-tabs-trigger][data-value="documents"]');
    const settings = root.locator('[data-essence-tabs-trigger][data-value="settings"]');
